    ...
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          {user ? (
            <div className="flex items-center justify-center h-full w-full bg-blue-600 text-white text-lg font-semibold">
              {initials || "U"}
            </div>
          ) : (
        ...
        <span className="block mr-1 font-medium text-theme-sm truncate max-w-[7rem]">
          {displayName}
        </span>
        <svg
